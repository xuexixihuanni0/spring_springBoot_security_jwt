...
import com.hydata.jwt_springboot_02.config.security.filter.JwtGenerateFilter;
import com.hydata.jwt_springboot_02.config.security.filter.JwtVerifyFilter;
import com.hydata.jwt_springboot_02.config.security.filter.ImageCodeVerifyFilter;
...
public class SecurityConfiguration extends WebSecurityConfigurerAdapter {
    ...
    @Autowired
    private JwtGenerateFilter jwtGenerateFilter;
    @Autowired
